...
function mostrarPregunta() {
    ...
    pregunta.opciones.forEach((opcion, index) => {
        ...
        if (respuestaActual && estadoApp.modo === 'estudio') {
            ...
            } else if (index === respuestaActual.seleccionada) {
            ...
            div.addEventListener('click', () => {
                if (estadoApp.modo === 'estudio') {
                    ...
                    seleccionarOpcionSimulacro(index);
                }
            });
            
            if (respuestaActual && index === respuestaActual.seleccionada) {
                div.classList.add('selected');
            }
        }
    ...
    temas.forEach(tema => {
        ...
        div.innerHTML = `
            <div class="tema-stat-header">
                <div class="tema-stat-nombre">${tema.nombre}</div>
